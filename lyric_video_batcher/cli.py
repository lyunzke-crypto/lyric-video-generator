...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--zoom-start", type=float, default=0.08)
    parser.add_argument("--zoom-end", type=float, default=2.8)
    parser.add_argument("--text-x", type=float, default=0.50)
    parser.add_argument("--text-y", type=float, default=0.42)
